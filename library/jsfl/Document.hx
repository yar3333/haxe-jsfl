...
typedef Document =
{
	 ...
	 * @param attrName A string that specifies the name of the TextAttrs property to be returned. For a list of property names and
	 * @param startIndex An integer that specifies the index of first character, with 0 (zero) specifying the first position. This
	...
	/**
	 * Flash 8.
	 * Returns an array that contains the list of filters applied to the currently selected object(s). If multiple objectsare selected and they donтАЩt have identical filters, this method returns the list of filters applied to the first selected object.
	 */
	 ...
	 */
	function getPublishDocumentData(format : String) : Bool;
	/**
	 * Flash MX 2004.
	 ...
	 */
	function getSWFPathFromProfile() : String;
	/**
	 * Flash Professional CC.
	 * Indicates whether if the “Enable detailed telemetry” checkbox is selected in the Publish Settings dialog.
	 * @return true if the “Enable detailed telemetry” checkbox is selected; otherwise false.
	 */
	function getTelemetryForSwf() : Bool;
	/**
	 * Flash MX 2004.
	 ...
	 * @param URI String; the absolute path to the cue point XML file.
	 */
	 ...
	 * @param bUseDocumentBounds A Boolean value that, when set to true, causes the method to match the size of the objects to
	 */
	 ...
	 * @param position A pair of floating-point values that specify the x and y coordinates of the click in pixels.
	 * @param bAltDown A Boolean value that records whether the Alt key is down at the time of the event: true for pressed; false
	 * @param bShiftDown A Boolean value that records whether the Shift key was down when the event occurred: true for pressed;
	 * @param bShiftSelect A Boolean value that indicates the state of the application preference Shift select: true for on; false
	 */
	 ...
	 * @param delta A pair of floating-point values that specify the x and y coordinates in pixels by which the selected B├йzier points
	 */
	 ...
	 * @param distanceToMove A pair of floating-point values that specify the x and y coordinate values by which the method
	 */
	 ...
	 * @param smoothing An integer in the range from 0 to 100, with 0 specifying no smoothing and 100 specifying maximum
	 * @param bUseMultiplePasses A Boolean value that, when set to true, indicates that the method should use multiple passes,
	 */
	 ...
	 * @param filterIndex An integer specifying the zero-based index of the filter to remove from the selected object(s).
	 */
	function removeFilter(filterIndex:Int) : Void;
	/**
	 * Flash MX 2004.
	 * Renames the current profile.
	 * @param profileNewName An optional parameter that specifies the new name for the profile. The new name must be unique.
	 */
	 ...
	 * @param sceneToPutItBefore An integer that specifies the scene before which you want to move the scene specified by
	 */
	 ...
	 * @param rotationPoint A string that specifies which side of the bounding box to rotate. Acceptable values are "top right",
	 */
	 ...
	 * @param whichCorner A string value that specifies the edge about which the transformation occurs. If omitted, scaling occurs
	 */
	 ...
	 * @param curveFit A string that specifies how smoothly outlines are drawn. Acceptable values are "pixels", "very tight",
	 * @param cornerThreshold A string that is similar to curveFit, but it pertains to the corners of the bitmap image. Acceptable
	 */
