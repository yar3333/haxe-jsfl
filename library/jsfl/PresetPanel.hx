...
typedef PresetPanel =
{
	 ...
	 * @bRecurse A Boolean value that specifies whether to expand or collapse the folderтАЩs subfolders (true) or not false).
	 ...
	 * @fileURI A string, expressed as a file:/// URI, that specifies the path and optionally a filename for the exported file. See
